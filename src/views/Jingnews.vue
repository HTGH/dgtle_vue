<style scoped>
    ...
    @import "../assets/css/jingnews.css";
</style>
<template>
    <div>
        <div class="jingnews-nav">
            <div class="jingnews-nav-content wp">
                <div class="nav-title">
                    <h2><a href="#">鲸闻</a><span>人文和科技的交汇</span></h2>
                </div>
            </div>
        </div>
        <!--轮播-->
        <div class="jingnews-banner-box wp">
            <div class="jingnews-banner">
                <!--文字轮播-->
                <div class="carousel" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="banner-info carousel-item active">
                            <h3><a href="#">新iphone终极爆料</a></h3>
                            <p>苹果秋季发布会已经不单单是苹果例行更新 iPhone 新机那么简单，经过一年又一年的更新迭代，它已经成功成为了手机爱好者们的一场科技「盛宴」。</p>
                            <div><a href="#">阅读全文</a></div>
                        </div>
                        <div class="banner-info carousel-item">
                            <h3><a href="#">更新 macOS Mojave 前，你需要做哪些准备？</a></h3>
                            <p>微软此前已经确定将于当地时间 10 月 2 日在纽约举行新品发布会</p>
                            <div><a href="#">阅读全文</a></div>
                        </div>
                        <div class="banner-info carousel-item">
                            <h3><a href="#">微软发布 Office 2019 正式版</a></h3>
                            <p>微软在近日举办的 Ignite 2018 大会上宣布，正式面向 Windows 和 Mac 用户推出 Office 2019 办公套件。</p>
                            <div><a href="#">阅读全文</a></div>
                        </div>
                        <div class="banner-info carousel-item">
                            <h3><a href="#">Surface Hub 2 体验如何？外媒上手后这样说</a></h3>
                            <p>外媒 Windows Central 在近日举行的 Ignite 2018 上先行体验了 Surface Hub 2。</p>
                            <div><a href="#">阅读全文</a></div>
                        </div>
                        <div class="banner-info carousel-item">
                            <h3><a href="#">苹果推出 macOS Mojave 正式版，你更新了吗？</a></h3>
                            <p>北京时间 9 月 25 日凌晨，苹果推出 macOS Mojave 正式版系统。</p>
                            <div><a href="#">阅读全文</a></div>
                        </div>
                        <div class="banner-info carousel-item">
                            <h3><a href="#">微软新品发布会前瞻：例行升级之外，会有惊喜吗？</a></h3>
                            <p>微软此前已经确定将于当地时间 10 月 2 日在纽约举行新品发布会，届时哪些产品将会在发布会中亮相也引人关注。</p>
                            <div><a href="#">阅读全文</a></div>
                        </div>
                        <div class="banner-info carousel-item">
                            <h3><a href="#">新iphone终极爆料</a></h3>
                ...
                <div class="carousel yy" data-ride="carousel">
                    <div class="next_new">下一条></div>
            ...
            <div class="sidebar">
                <div class="sidebar-1">鲸闻头条</div>
                <div class="sidebar-2">今日必读资讯</div>
            </div>
        ...
        <div class="details">
            ...
            <div>
                <div class="wp cl">
                    <!--导航-->
                    <ul class="jingnewsUl">
                        <li class="active"><a href="#">全部</a><i class="borde"></i></li>
                        <li><a href="#">快讯</a><i class="borde"></i></li>
                        <li><a href="#">图说</a><i class="borde"></i></li>
                        <li><a href="#">言论</a><i class="borde"></i></li>
                        <li><a href="#">产品</a><i class="borde"></i></li>
                        <li><a href="#">公司</a><i class="borde"></i></li>
                        <li><a href="#">读数</a><i class="borde"></i></li>
                        <li><a href="#">百科</a><i class="borde"></i></li>
                        <li><a href="#">每日一言</a><i class="borde"></i></li>
                    </ul>
                    <!--内容-->
                </div>
                <div class="news">
                    ...
                    <div class="flex_right">
                        <div class="flex_right_item" v-for="(item,i) in list">
                            <img :src=item.img class="zimg">
                            <h4>{{item.title}}</h4>
                            <p>{{item.news}}</p>
                            <b>{{item.name}}</b><span>{{item.time | dateFormat}}</span>
                            <div>
                                <span class="xin" @click="xin(item.nid,i)"></span><span>&nbsp;&nbsp;&nbsp;{{item.xin}}</span>
                            </div>
                            <a target="_blank" class="forum-type">{{item.fname}}</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    export default {
        data(){
            return{
                list:[],
                xin_src:"img/news/news/xin1.png"
            }
        },
        methods:{
            news_load(){
                this.$http.get("jingnews/newlist").then(result=>{
                        this.list=result.body;
                });
            },
            xin(nid,i){
                    this.list[i].xin++;
                    var obj={nid:this.list[i].nid,xin:this.list[i].xin};
                    var url="jingnews/xin";
